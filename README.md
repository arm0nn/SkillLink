...
| Aminul Shahir Bin Mohd Aminuddin | 2228907 | login/register **CODES:** `lib/screens/auth/splash_screen.dart`, `landing_screen.dart`, `login_screen.dart`, `register_screen.dart`, `providers/auth_provider.dart`, `services/auth_service.dart`, `widgets/custom_button.dart`, `custom_textfield.dart`, `utils/validators.dart` |
